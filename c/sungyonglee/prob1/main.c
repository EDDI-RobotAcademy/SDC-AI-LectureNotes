...
int main (void)
{
    ...
    // 6번 문제
    printf("6. result = %d\n", numer_align_with_parameter(10, 1040));
    printf("6. result = %d\n", numer_align_with_parameter(5, 776));
    printf("6. result = %d\n", numer_align_with_parameter(2, 123));
    printf("6. result = %d\n", numer_align_with_parameter(5, 64));
    ...
    // 12번 문제
    // Meomory 구조(Stack, Heap, Data, Text)에 대해 기술하시오
    // Stack : 지역 변수
    ...
    // 13번 문제
    printf("13. result = %d\n", process_data(doit(3, 7), letsgo(3, 7)));
    ...
    // 15번 문제
    printf("결과 = %d\n", return_integer_from_int_float_parameter(3, 7.));
    return 0;
}
