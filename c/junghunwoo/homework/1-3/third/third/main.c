...
int main(void)
{
	...
	{
		printf("%s는 %d %s는 %d으로 %s가 이겼습니다.", player1_name, player1_score, player2_name, player2_score, player1_name);
	}
	else
	{
		printf("%s는 %d %s는 %d으로 무승부입니다.", player1_name, player1_score, player2_name, player2_score);
	}
