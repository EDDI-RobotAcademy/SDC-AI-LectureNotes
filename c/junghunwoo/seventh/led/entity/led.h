...
// 사용시 정보라는 것은 처음 회원가입을 할 때 객체가 만들어집니다.
// 그리고 회원 탈퇴를 할 떄 객체의 수명이 끝나게 됩니다.
...
//typedef는 #define과 거의 유사함
//차이가 있다면 #define으로 type을 만들지는 못함
//그러나 typedef는 특정 타입을 만드는 작업을 수행함
//고로 typedef struct _led led는 아래를 의믜함
//struct _led로 적어야 하는 문법을 ledㄹ 퉁치겠습니다.
