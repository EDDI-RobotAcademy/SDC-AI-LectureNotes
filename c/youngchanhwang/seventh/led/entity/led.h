...
// typedef 는 사실상 #define 과 거의 유사함
// 차이가 있다면 #define 으로 type 을 만들지는 못함
// 그러나 typedef 는 특정 타입을 만드는 작업을 수행함
// 고로 typedef struct _led led 는 아래를 의미함
// struct _led 로 적어야 하는 문법을 led 로 퉁치겠습니다.
