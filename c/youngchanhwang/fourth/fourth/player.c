...
// 
// 0x00007FF70277D720  66 69 72 73 74 5f 70 6c  first_pl
// 0x00007FF70277D728  61 79 65 72 00 00 00 00  ayer....
// 0x00007FF70277D730  00 00 00 00 00 00 00 00  ........
// 0x00007FF70277D738  00 00 00 00 00 00 00 00  ........	<<<- 4줄이니까 32
// 
// 0x00007FF70277D740  73 65 63 6f 6e 64 5f 70  second_p
// 0x00007FF70277D748  6c 61 79 65 72 00 00 00  layer...
// 0x00007FF70277D750  00 00 00 00 00 00 00 00  ........
// 0x00007FF70277D758  00 00 00 00 00 00 00 00  ........	<<<- 4줄이니까 32
//
...
// ex) test[3][2][10]
//	이 형태라면 10개의 공간이 2개있음
//	즉 20개짜리 공간이 됨
//	이 20개짜리 공간이 3개 있다는 뜻
//	결론적으로 60개의 공간을 가짐

void set_player_info(char name[])
{
	int input_player_name_length = strlen(name);
	// player[2][32]에서 current_player_set_index 를 통해
	// 0번, 1번을 제어하고자 하는 목적
