...
// 진정한 목적은 type을 custom 하겠다는 것이 주요합니다.

led *init_led_object(int count);
void set_led_status(led *led_array, int led_index, bool on_off);
