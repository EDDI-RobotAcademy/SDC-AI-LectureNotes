...
int main (void)
{
    ...
    char contents[SLAB_CACHE] = "적벽";
    char read_buffer[SLAB_CACHE];

    test_form *format;
    char major[SLAB_CACHE] = "조조";
    char self_introduction[SLAB_CACHE3] = "딴딴하게!";

    test_form *format2;
    char major2[SLAB_CACHE] = "제갈량";
    char self_introduction2[SLAB_CACHE3] = "화공이다!";

    // 0644는 8진수임
    int created_file_descriptor = file_open(
        "/home/eddi/proj/SDC-AI-LectureNotes/"
        "c/sungyoungjang/thirteenth/created_file/이거만들래.txt", O_CREAT | O_RDWR | O_TRUNC, 0644);
    ...
    created_file_descriptor = file_open(
        "/home/eddi/proj/SDC-AI-LectureNotes/"
        "c/sungyoungjang/thirteenth/created_file/format_test.txt", O_CREAT | O_RDWR | O_TRUNC, 0644);
