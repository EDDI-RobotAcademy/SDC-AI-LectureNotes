...
int main (void)
{
    ...
    int created_file_descriptor = file_open(
        ...
        "c/seunghunjo/thirteenth/created_file/이거만들래.txt", O_CREAT | O_RDWR | O_TRUNC, 0644);
    ...
    created_file_descriptor = file_open(
        "/home/eddi/proj/SDC-AI-LectureNotes/"
        "c/seunghunjo/thirteenth/created_file/format_test.txt", O_CREAT | O_RDWR | O_TRUNC, 0644);
