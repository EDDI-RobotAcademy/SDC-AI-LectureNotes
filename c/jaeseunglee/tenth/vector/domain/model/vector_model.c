...
vector_model *init_vector_model_object(void)
{
    ...
    tmp_vector->x = generate_random_min_to_max(VECTOR_MIN, VECTOR_MAX);
    tmp_vector->y = generate_random_min_to_max(VECTOR_MIN, VECTOR_MAX);
    tmp_vector->z = generate_random_min_to_max(VECTOR_MIN, VECTOR_MAX);
...
void set_vector_model_object_with_value(vector_model *vector_object, float x, float y, float z)
{
    vector_object->x = x;
    vector_object->y = y;
    vector_object->z = z;
